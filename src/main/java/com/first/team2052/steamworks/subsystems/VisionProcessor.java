...
public class VisionProcessor {
    ...
    private int xResolution = 240, yResolution = 180;
...
//        NetworkTable.setClientMode();
    ...
    public VisionTrackingTurnAngleResult getXAngleFromCenter() {
        ...
        return new VisionTrackingTurnAngleResult(true, turnPercent);
    ...
    public static VisionTrackingTurnAngleResult InvalidTurnAngleResult = new VisionTrackingTurnAngleResult(false, 0);
}
