...
public class PosBoilerGearShoot extends AutoMode {
    ...
    protected void init() throws AutoModeEndedException {
        ...
        forwardPath.add(new Path.Waypoint(new Translation2d(distance - 30, 0), 40));
        forwardPath.add(new Path.Waypoint(new Translation2d(distance, 0), 30));
        forwardPath.add(new Path.Waypoint(new Translation2d(distance + ((distance_to_peg_polar - 20) * Math.cos(Math.PI / 3)), -((distance_to_peg_polar - 20) * Math.sin(Math.PI / 3))), 40));
        forwardPath.add(new Path.Waypoint(new Translation2d(distance + (distance_to_peg_polar * Math.cos(Math.PI / 3)), -(distance_to_peg_polar * Math.sin(Math.PI / 3))), 40));

        List<Path.Waypoint> backwardPath = Lists.newArrayList();
        backwardPath.add(new Path.Waypoint(new Translation2d(distance + (distance_to_peg_polar * Math.cos(Math.PI / 3)), -(distance_to_peg_polar * Math.sin(Math.PI / 3))), 40));
        backwardPath.add(new Path.Waypoint(new Translation2d(distance + (20 * Math.cos(Math.PI / 3)), -(20 * Math.sin(Math.PI / 3))), 60));
        backwardPath.add(new Path.Waypoint(new Translation2d(distance, 0), 40, "CloseGearMan"));
        backwardPath.add(new Path.Waypoint(new Translation2d(distance_backward - (15 * Math.cos(turn)), 15 * Math.sin(turn)), 30));
        backwardPath.add(new Path.Waypoint(new Translation2d(distance_backward - (39 * Math.cos(turn)), 39 * Math.sin(turn)), 20));
