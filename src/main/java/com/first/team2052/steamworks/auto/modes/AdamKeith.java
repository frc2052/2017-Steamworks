...
import java.util.List;
     ...
     * Ends: Airship
     */
    public class AdamKeith extends AutoMode {
        @Override
        protected void init() throws AutoModeEndedException {
            ...
            forwardPath.add(new Path.Waypoint(new Translation2d(80, 0), 20));
            forwardPath.add(new Path.Waypoint(new Translation2d(80, 80), 20));
            forwardPath.add(new Path.Waypoint(new Translation2d(0, 80), 20));
