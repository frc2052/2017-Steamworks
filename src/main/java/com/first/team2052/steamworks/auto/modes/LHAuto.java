 ...
 * Ends: Airship
 */
public class LHAuto extends AutoMode {
    @Override
    protected void init() throws AutoModeEndedException {
        ...
        forwardPath.add(new Path.Waypoint(new Translation2d(60, 0), 40));
        forwardPath.add(new Path.Waypoint(new Translation2d(80, 20), 40));
